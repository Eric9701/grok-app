...
export const enErrors = {
  ...
  "error.deck.quota.problem": "Included usage is used up",
  "error.deck.quota.cause": "Official included quota for this model is exhausted, or the provider returned a hard usage / credit limit. Usage resets on a rolling window. Open Account to check the plan, or wait for the reset.",
